...
public class Stage2FrameNaruto extends javax.swing.JFrame implements PerformAnimation, Perform {
    ...
    EnemyInfo enemy = objInfo.initEnemyAttributes(8);
    
    LeaderboardUpdate ldu = new LeaderboardUpdate();
    private String playerName;

    public Stage2FrameNaruto(String name) {
   ...
   //3
    ...
    private class AttackKeyListener implements KeyListener {
           ...
           switch (e.getKeyCode()) {
               ...
               case KeyEvent.VK_Q:
                ...
                if (hero.getCurrentMana() >= hero.getBaseMana()) {
                    ...
                    leaderboard.updatePlayerStage(hp.getPlayerName(), 2);
                    openNextStageFrame();
                    }
     ...
     private void openNextStageFrame() {
        Stage3FrameNaruto naruto = new Stage3FrameNaruto(playerName); // Create a new JFrame for the next stage
    ...
    private void initComponents() {
        ...
        getContentPane().add(lblEnemySkillEffect, new org.netbeans.lib.awtextra.AbsoluteConstraints(-280, 440, 680, 220));
        ...
        getContentPane().add(lblEnemySpecialEffect, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 380, 510, 420));
        ...
        getContentPane().add(lblEnemySpecialEffect2, new org.netbeans.lib.awtextra.AbsoluteConstraints(-420, -50, 1400, 730));
        ...
        getContentPane().add(lblEnemySkillAttack, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 280, 680, 600));

        lblEnemyChargeEffect.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Pain/special1.png"))); // NOI18N
        getContentPane().add(lblEnemyChargeEffect, new org.netbeans.lib.awtextra.AbsoluteConstraints(630, 490, -1, 180));
        ...
        getContentPane().add(lblEnemySpecialAttack, new org.netbeans.lib.awtextra.AbsoluteConstraints(490, 450, 380, 280));
        ...
        getContentPane().add(lblEnemyBasicAttack, new org.netbeans.lib.awtextra.AbsoluteConstraints(-260, 440, 680, 250));
        ...
        lblHeroBasicAttack.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Naruto/Smash.png"))); // NOI18N
        ...
        lblEnemy.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Pain/Stance1.png"))); // NOI18N
        getContentPane().add(lblEnemy, new org.netbeans.lib.awtextra.AbsoluteConstraints(650, 450, 180, 260));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Stage2FrameNaruto.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        Stage2FrameNaruto sl = new Stage2FrameNaruto(defaultPlayerName);
