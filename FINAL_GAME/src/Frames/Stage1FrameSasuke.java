 ...
 * @author Philip
 */
public class Stage1FrameSasuke extends javax.swing.JFrame implements PerformAnimation, Perform{
    ...
    HeroInfo hero = objInfo.initHeroAttributes(2);
    ...
    public Stage1FrameSasuke(String name) {
    ...
    private void initializeAnimation() {
        ...
        HeroDamagedEffect = new ImageIcon(getClass().getResource("/Sasuke/SasukeDamaged.png"));
    ...
    public void HeroBasicAttackAnimation() {
        ...
        Timer skillAttackTimer = new Timer(150, e -> {
    ...
    public void HeroBasicEffectAnimation() {
        ...
        Timer explosionTimer = new Timer(30, e -> {
            lblEnemy.setIcon(EnemyDamagedEffect);
   ...
   @Override
    ...
    private void openNextStageFrame() {
        Stage2FrameSasuke sasuke = new Stage2FrameSasuke(playerName); // Create a new JFrame for the next stage
    ...
    private void initComponents() {
        ...
        getContentPane().add(lblEnemySpecialEffect, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, -100, 510, 420));

        lblEnemySpecialEffect2.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        lblEnemySpecialEffect2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/MadaraEnemy/ss12.png"))); // NOI18N
        ...
        lblHeroChargeEffect.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Sasuke/ss1.png"))); // NOI18N
        lblHeroChargeEffect.setVerticalAlignment(javax.swing.SwingConstants.BOTTOM);
        getContentPane().add(lblHeroChargeEffect, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 320, -1, 360));

        lblHeroSpecialAttack.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        lblHeroSpecialAttack.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Sasuke/ss1.png"))); // NOI18N
        lblHeroSpecialAttack.setVerticalAlignment(javax.swing.SwingConstants.BOTTOM);
        getContentPane().add(lblHeroSpecialAttack, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 120, 460, 560));

        lblHeroSpecialEffect.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        lblHeroSpecialEffect.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Sasuke/ss27.png"))); // NOI18N
        lblHeroSpecialEffect.setVerticalAlignment(javax.swing.SwingConstants.BOTTOM);
        getContentPane().add(lblHeroSpecialEffect, new org.netbeans.lib.awtextra.AbsoluteConstraints(290, 290, 320, 250));
        ...
        lblHeroSkillEffect.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Sasuke/terasu1.png"))); // NOI18N
        lblHeroSkillEffect.setVerticalAlignment(javax.swing.SwingConstants.BOTTOM);
        getContentPane().add(lblHeroSkillEffect, new org.netbeans.lib.awtextra.AbsoluteConstraints(410, 310, 500, 340));

        lblHeroSkillAttack.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Sasuke/amat1.png"))); // NOI18N
        getContentPane().add(lblHeroSkillAttack, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 480, -1, 180));
        ...
        lblHeroBasicEffect.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Sasuke/chidori20.png"))); // NOI18N
        getContentPane().add(lblHeroBasicEffect, new org.netbeans.lib.awtextra.AbsoluteConstraints(370, 470, 450, 220));
        ...
        lblHeroDead.setIcon(new javax.swing.ImageIcon(getClass().getResource("/dyingImages/sasdead.png"))); // NOI18N
        getContentPane().add(lblHeroDead, new org.netbeans.lib.awtextra.AbsoluteConstraints(140, 550, 140, -1));

        lblHero.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        lblHero.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Sasuke/stance1.png"))); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Stage1FrameSasuke.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        Stage1FrameSasuke sl = new Stage1FrameSasuke(defaultPlayerName);
