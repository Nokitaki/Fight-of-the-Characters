 ...
 * @author Philip
 */
public class Stage3FrameNaruto extends javax.swing.JFrame implements PerformAnimation, Perform {
    ...
    public Stage3FrameNaruto(String name) {
   ...
   //3
    ...
    private void initComponents() {
        ...
        getContentPane().add(lblEnemySpecialEffect, new org.netbeans.lib.awtextra.AbsoluteConstraints(-140, 100, 840, 850));
        ...
        getContentPane().add(lblEnemySpecialEffect2, new org.netbeans.lib.awtextra.AbsoluteConstraints(-420, -70, 1400, 730));
        ...
        getContentPane().add(lblEnemySpecialAttack, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 440, 380, 280));
        ...
        getContentPane().add(lblEnemySkillAttack, new org.netbeans.lib.awtextra.AbsoluteConstraints(-300, 280, 680, 600));

        lblEnemyChargeEffect.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Yuji/yujicharge1.png"))); // NOI18N
        getContentPane().add(lblEnemyChargeEffect, new org.netbeans.lib.awtextra.AbsoluteConstraints(600, 480, -1, 180));
        ...
        getContentPane().add(lblEnemyBasicAttack, new org.netbeans.lib.awtextra.AbsoluteConstraints(-250, 440, 680, 250));
        ...
        getContentPane().add(lblEnemy, new org.netbeans.lib.awtextra.AbsoluteConstraints(630, 440, 180, 260));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Stage3FrameNaruto.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        Stage3FrameNaruto sl = new Stage3FrameNaruto(defaultPlayerName);
