 ...
 * @author Philip
 */
public class Stage2FrameGojo extends javax.swing.JFrame implements PerformAnimation, Perform {
    ...
    public Stage2FrameGojo(String name) {
    ...
    public void HeroSpecialEffectAnimation(){
        ...
        attackCurrentImageIndex = 0; // Reset the attack frame index
        lblHeroSpecialEffect.setIcon(hero.getHeroSpecialEffect2()[attackCurrentImageIndex]);
   ...
   @Override
    ...
    private class AttackKeyListener implements KeyListener {
     ...
     private void openNextStageFrame() {
        Stage3FrameGojo gojo = new Stage3FrameGojo(playerName); // Create a new JFrame for the next stage
    ...
    private void initComponents() {
        ...
        lblHeroSpecialEffect.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Gojo/ss_pain.png"))); // NOI18N
        lblHeroSpecialEffect.setToolTipText("");
        getContentPane().add(lblHeroSpecialEffect, new org.netbeans.lib.awtextra.AbsoluteConstraints(-210, -40, 1370, 800));
        ...
        getContentPane().add(lblEnemy, new org.netbeans.lib.awtextra.AbsoluteConstraints(650, 470, 120, 190));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Stage2FrameGojo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        Stage2FrameGojo sl = new Stage2FrameGojo(defaultPlayerName);
