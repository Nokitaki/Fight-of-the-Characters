...
import Frames.PerformAnimation;
...
public class Stage2FrameSasuke extends javax.swing.JFrame implements PerformAnimation, Perform {
    ...
    public Stage2FrameSasuke(String name) {
   ...
   //3
    ...
    private class AttackKeyListener implements KeyListener {
     ...
     private void openNextStageFrame() {
        Stage3FrameSasuke sasuke = new Stage3FrameSasuke(playerName); // Create a new JFrame for the next stage
    ...
    private void initComponents() {
        ...
        getContentPane().add(lblEnemySpecialAttack, new org.netbeans.lib.awtextra.AbsoluteConstraints(490, 400, 380, 340));
        ...
        getContentPane().add(lblEnemySpecialEffect2, new org.netbeans.lib.awtextra.AbsoluteConstraints(-430, -30, 1400, 730));
        ...
        getContentPane().add(lblEnemySpecialEffect, new org.netbeans.lib.awtextra.AbsoluteConstraints(-100, 310, 730, 550));

        lblEnemySkillEffect.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Pain/skilleffect1.png"))); // NOI18N
        getContentPane().add(lblEnemySkillEffect, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 230, 670, 540));

        lblEnemySkillAttack.setHorizontalAlignment(javax.swing.SwingConstants.RIGHT);
        lblEnemySkillAttack.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Pain/5th sp1.png"))); // NOI18N
        getContentPane().add(lblEnemySkillAttack, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 270, 680, 600));
        ...
        getContentPane().add(lblEnemyBasicAttack, new org.netbeans.lib.awtextra.AbsoluteConstraints(-310, 440, 680, 250));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Stage2FrameSasuke.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        Stage2FrameSasuke sl = new Stage2FrameSasuke(defaultPlayerName);
