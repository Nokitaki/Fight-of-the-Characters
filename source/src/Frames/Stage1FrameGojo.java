 ...
 * @author Philip
 */
public class Stage1FrameGojo extends javax.swing.JFrame implements PerformAnimation, Perform {
    ...
    public Stage1FrameGojo(String name) {
   ...
   @Override
    ...
    private class AttackKeyListener implements KeyListener {
     ...
     private void openNextStageFrame() {
        Stage2FrameGojo gojo = new Stage2FrameGojo(playerName); // Create a new JFrame for the next stage
    ...
    private void initComponents() {
        ...
        lblEnemySpecialEffect2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/MadaraEnemy/bom2.png"))); // NOI18N
        ...
        getContentPane().add(lblHeroSpecialEffect, new org.netbeans.lib.awtextra.AbsoluteConstraints(-360, -130, 1710, 970));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Stage1FrameGojo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        /* Create and display the form */
         ...
         Stage1FrameGojo sl = new Stage1FrameGojo(defaultPlayerName);
