 ...
 * @author Joel
 */
public class Stage3FrameIchigo extends javax.swing.JFrame implements PerformAnimation, Perform {
    ...
    EnemyInfo enemy = objInfo.initEnemyAttributes(7); //IMPORTANT ONCE COPYING

    private String playerName; 
    LeaderboardUpdate ldu = new LeaderboardUpdate();
    
    
    public Stage3FrameIchigo(String name) {
   ...
   @Override
    public void EnemySpecialAttackAnimation() {
        ...
        Timer specialAttackMadara = new Timer(120, e -> {
            // Check if all RasenEffect frames have been shown
    ...
    private void initComponents() {
        ...
        getContentPane().add(lblEnemySpecialEffect, new org.netbeans.lib.awtextra.AbsoluteConstraints(-180, 140, 840, 720));
        ...
        getContentPane().add(lblEnemySpecialEffect2, new org.netbeans.lib.awtextra.AbsoluteConstraints(-440, -80, 1400, 730));
        ...
        getContentPane().add(lblEnemySkillAttack, new org.netbeans.lib.awtextra.AbsoluteConstraints(-300, 260, 680, 600));
        ...
        getContentPane().add(lblEnemySpecialAttack, new org.netbeans.lib.awtextra.AbsoluteConstraints(140, 420, 380, 280));

        lblEnemyChargeEffect.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Yuji/yujicharge1.png"))); // NOI18N
        getContentPane().add(lblEnemyChargeEffect, new org.netbeans.lib.awtextra.AbsoluteConstraints(610, 460, 220, 200));
        ...
        lblHeroTrans.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Ichigo/intro2.png"))); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Stage3FrameIchigo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        Stage3FrameIchigo sl = new Stage3FrameIchigo(defaultPlayerName);
