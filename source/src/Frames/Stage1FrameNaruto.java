 ...
 * @author Joel
 */
public class Stage1FrameNaruto extends javax.swing.JFrame implements PerformAnimation, Perform{
    ...
    HeroInfo hero = objInfo.initHeroAttributes(1);
    EnemyInfo enemy = objInfo.initEnemyAttributes(5);
    ...
    public Stage1FrameNaruto(String name) {
        this.playerName = name;
        System.out.println("This is the name: "+playerName);
    ...
    private void initializeAnimation() {
        ...
        EnemyDamagedEffect = new ImageIcon(getClass().getResource("/MadaraEnemy/Backward.png"));
        HeroDamagedEffect = new ImageIcon(getClass().getResource("/Naruto/NarutoDamaged.png"));
        ...
        lblHeroSpecialEffectExtension.setVisible(false);
        lblHeroSpecialEffectExtension1.setVisible(false);
        lblHeroSpecialEffectExtension2.setVisible(false);
        lblHeroSpecialEffectExtension3.setVisible(false);
        lblHeroSpecialEffectExtension4.setVisible(false);
        lblHeroSpecialEffectExtension5.setVisible(false);
    ...
    public void HeroChargeEffectAnimation() {
        ...
        Timer chargeHero = new Timer(100, e -> {
    ...
    public void HeroSkillAttackAnimation() {
        ...
        Timer attackTimer = new Timer(100, e -> {
            // Check if all attack frames have been shown
        ...
        attackTimer.start(); // Start the attack animation timer
    }
    ...
    public void HeroSpecialEffectAnimation(){
        ...
        Timer blastTimer = new Timer(100, e -> {
            // Check if all RasenEffect frames have been shown
            lblEnemy.setIcon(EnemyDamagedEffect);
            ...
            if (attackCurrentImageIndex > 0 && attackCurrentImageIndex < 4) {
                lblHeroSpecialEffectExtension.setVisible(true);
                lblHeroSpecialEffectExtension1.setVisible(true);
                lblHeroSpecialEffectExtension2.setVisible(true);
                lblHeroSpecialEffectExtension3.setVisible(true);
                lblHeroSpecialEffectExtension4.setVisible(true);
                lblHeroSpecialEffectExtension5.setVisible(true);
            } 
   ...
   //3
           ...
           switch (e.getKeyCode()) {
               ...
               case KeyEvent.VK_Q:
                ...
                if (hero.getCurrentMana() >= hero.getBaseMana()) {
                    ...
                    leaderboard.updatePlayerStage(hp.getPlayerName(), 1);
                    openNextStageFrame();
                    }
    ...
    private void openNextStageFrame() {
        Stage2FrameNaruto naruto = new Stage2FrameNaruto(playerName); // Create a new JFrame for the next stage
    ...
    private void initComponents() {
        ...
        lblHeroSpecialEffectExtension5 = new javax.swing.JLabel();
        lblHeroSpecialEffectExtension4 = new javax.swing.JLabel();
        lblHeroSpecialEffectExtension3 = new javax.swing.JLabel();
        lblHeroSpecialEffectExtension2 = new javax.swing.JLabel();
        lblHeroSpecialEffectExtension1 = new javax.swing.JLabel();
        lblHeroSpecialEffectExtension = new javax.swing.JLabel();
        ...
        lblHeroBasicAttack.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Naruto/Smash5.png"))); // NOI18N
        getContentPane().add(lblHeroBasicAttack, new org.netbeans.lib.awtextra.AbsoluteConstraints(500, 500, -1, 180));

        lblEnemyChargeEffect.setIcon(new javax.swing.ImageIcon(getClass().getResource("/MadaraEnemy/char1.png"))); // NOI18N
        getContentPane().add(lblEnemyChargeEffect, new org.netbeans.lib.awtextra.AbsoluteConstraints(640, 460, -1, 180));

        lblEnemySpecialEffect.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        lblEnemySpecialEffect.setIcon(new javax.swing.ImageIcon(getClass().getResource("/MadaraEnemy/ss12.png"))); // NOI18N
        getContentPane().add(lblEnemySpecialEffect, new org.netbeans.lib.awtextra.AbsoluteConstraints(190, -100, 510, 420));

        lblEnemySpecialEffect2.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        lblEnemySpecialEffect2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/MadaraEnemy/bom1.png"))); // NOI18N
        lblEnemySpecialEffect2.setVerticalAlignment(javax.swing.SwingConstants.BOTTOM);
        getContentPane().add(lblEnemySpecialEffect2, new org.netbeans.lib.awtextra.AbsoluteConstraints(-440, 0, 1400, 730));

        lblEnemySpecialAttack.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        lblEnemySpecialAttack.setIcon(new javax.swing.ImageIcon(getClass().getResource("/MadaraEnemy/Chibaku Tensei.png"))); // NOI18N
        getContentPane().add(lblEnemySpecialAttack, new org.netbeans.lib.awtextra.AbsoluteConstraints(500, 410, 380, 280));
        ...
        lblEnemySkillAttack.setIcon(new javax.swing.ImageIcon(getClass().getResource("/MadaraEnemy/Senpo_ Ranton Koga.png"))); // NOI18N
        getContentPane().add(lblEnemySkillAttack, new org.netbeans.lib.awtextra.AbsoluteConstraints(-100, 270, 680, 600));

        lblHeroSpecialEffectExtension5.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        lblHeroSpecialEffectExtension5.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Naruto/SpecialEffect4.png"))); // NOI18N
        getContentPane().add(lblHeroSpecialEffectExtension5, new org.netbeans.lib.awtextra.AbsoluteConstraints(870, 550, 140, 50));

        lblHeroSpecialEffectExtension4.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        lblHeroSpecialEffectExtension4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Naruto/SpecialEffect4.png"))); // NOI18N
        getContentPane().add(lblHeroSpecialEffectExtension4, new org.netbeans.lib.awtextra.AbsoluteConstraints(780, 550, 140, 50));

        lblHeroSpecialEffectExtension3.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        lblHeroSpecialEffectExtension3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Naruto/SpecialEffect4.png"))); // NOI18N
        getContentPane().add(lblHeroSpecialEffectExtension3, new org.netbeans.lib.awtextra.AbsoluteConstraints(690, 550, 140, 50));

        lblHeroSpecialEffectExtension2.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        lblHeroSpecialEffectExtension2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Naruto/SpecialEffect4.png"))); // NOI18N
        getContentPane().add(lblHeroSpecialEffectExtension2, new org.netbeans.lib.awtextra.AbsoluteConstraints(600, 550, 140, 50));

        lblHeroSpecialEffectExtension1.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        lblHeroSpecialEffectExtension1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Naruto/SpecialEffect4.png"))); // NOI18N
        getContentPane().add(lblHeroSpecialEffectExtension1, new org.netbeans.lib.awtextra.AbsoluteConstraints(510, 550, 140, 50));

        lblHeroSpecialEffectExtension.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        lblHeroSpecialEffectExtension.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Naruto/SpecialEffect4.png"))); // NOI18N
        getContentPane().add(lblHeroSpecialEffectExtension, new org.netbeans.lib.awtextra.AbsoluteConstraints(420, 550, 140, 50));

        lblHeroSpecialEffect.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        lblHeroSpecialEffect.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Naruto/SpecialEffect2.png"))); // NOI18N
        getContentPane().add(lblHeroSpecialEffect, new org.netbeans.lib.awtextra.AbsoluteConstraints(330, 490, 420, 170));

        lblHeroSpecialAttack.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Naruto/Special.png"))); // NOI18N
        getContentPane().add(lblHeroSpecialAttack, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 480, -1, 180));
        ...
        lblHeroChargeEffect.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Naruto/Recharge1.png"))); // NOI18N
        getContentPane().add(lblHeroChargeEffect, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 470, -1, 180));

        lblHeroBasicEffect.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Naruto/Explosion.png"))); // NOI18N
        getContentPane().add(lblHeroBasicEffect, new org.netbeans.lib.awtextra.AbsoluteConstraints(590, 430, 240, 230));

        lblEnemyBasicAttack.setHorizontalAlignment(javax.swing.SwingConstants.RIGHT);
        lblEnemyBasicAttack.setIcon(new javax.swing.ImageIcon(getClass().getResource("/MadaraEnemy/Katon_ Gōkakyū No Jutsu.png"))); // NOI18N
        getContentPane().add(lblEnemyBasicAttack, new org.netbeans.lib.awtextra.AbsoluteConstraints(-50, 430, 680, 250));

        lblHeroSkillAttack.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Naruto/Stance.png"))); // NOI18N
        getContentPane().add(lblHeroSkillAttack, new org.netbeans.lib.awtextra.AbsoluteConstraints(470, 480, -1, 180));

        lblHeroSkillEffect.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Naruto/RasenEffect.png"))); // NOI18N
        getContentPane().add(lblHeroSkillEffect, new org.netbeans.lib.awtextra.AbsoluteConstraints(580, 400, 300, 280));

        lblEnemy.setIcon(new javax.swing.ImageIcon(getClass().getResource("/MadaraEnemy/Idle.png"))); // NOI18N
        getContentPane().add(lblEnemy, new org.netbeans.lib.awtextra.AbsoluteConstraints(640, 420, 180, 260));

        lblEnemyDead.setIcon(new javax.swing.ImageIcon(getClass().getResource("/dyingImages/madadead.png"))); // NOI18N
        getContentPane().add(lblEnemyDead, new org.netbeans.lib.awtextra.AbsoluteConstraints(640, 530, 200, 190));

        lblHeroDead.setIcon(new javax.swing.ImageIcon(getClass().getResource("/dyingImages/narudead.png"))); // NOI18N
        getContentPane().add(lblHeroDead, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 530, -1, 180));

        lblHero.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Naruto/Stance.png"))); // NOI18N
        getContentPane().add(lblHero, new org.netbeans.lib.awtextra.AbsoluteConstraints(190, 480, -1, 180));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Stage1FrameNaruto.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        Stage1FrameNaruto sl = new Stage1FrameNaruto(defaultPlayerName);
    ...
    private javax.swing.JLabel lblHeroSpecialEffectExtension;
    private javax.swing.JLabel lblHeroSpecialEffectExtension1;
    private javax.swing.JLabel lblHeroSpecialEffectExtension2;
    private javax.swing.JLabel lblHeroSpecialEffectExtension3;
    private javax.swing.JLabel lblHeroSpecialEffectExtension4;
    private javax.swing.JLabel lblHeroSpecialEffectExtension5;
