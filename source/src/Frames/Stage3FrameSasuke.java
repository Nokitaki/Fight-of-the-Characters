 ...
 * @author Joel
 */
public class Stage3FrameSasuke extends javax.swing.JFrame implements PerformAnimation, Perform {
    ...
    public Stage3FrameSasuke(String name) {
   ...
   @Override
    ...
    private void initComponents() {
        ...
        getContentPane().add(lblEnemySpecialEffect, new org.netbeans.lib.awtextra.AbsoluteConstraints(-190, 100, 880, 800));
        ...
        getContentPane().add(lblEnemySpecialEffect2, new org.netbeans.lib.awtextra.AbsoluteConstraints(-430, -90, 1400, 730));
        ...
        getContentPane().add(lblEnemySpecialAttack, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 380, 380, 340));
        ...
        getContentPane().add(lblEnemyBasicAttack, new org.netbeans.lib.awtextra.AbsoluteConstraints(-270, 430, 680, 250));

        lblEnemyChargeEffect.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Yuji/yujicharge1.png"))); // NOI18N
        getContentPane().add(lblEnemyChargeEffect, new org.netbeans.lib.awtextra.AbsoluteConstraints(590, 470, 220, 200));
        ...
        getContentPane().add(lblEnemySkillAttack, new org.netbeans.lib.awtextra.AbsoluteConstraints(-330, 270, 680, 600));

        lblEnemySkillEffect.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Pain/skilleffect1.png"))); // NOI18N
        getContentPane().add(lblEnemySkillEffect, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 200, 670, 640));
        ...
        getContentPane().add(lblEnemy, new org.netbeans.lib.awtextra.AbsoluteConstraints(620, 470, 120, 190));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Stage3FrameSasuke.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        Stage3FrameSasuke sl = new Stage3FrameSasuke(defaultPlayerName);
