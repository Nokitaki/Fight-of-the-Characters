 ...
 * @author Joel
 */
public class Stage1FrameIchigo extends javax.swing.JFrame implements PerformAnimation, Perform {
    ...
    EnemyInfo enemy = objInfo.initEnemyAttributes(5); //IMPORTANT ONCE COPYING
    ...
    public Stage1FrameIchigo(String name) {
   ...
   @Override
    ...
    private class AttackKeyListener implements KeyListener {
     ...
     private void openNextStageFrame() {
        Stage2FrameIchigo ichi = new Stage2FrameIchigo(playerName); // Create a new JFrame for the next stage
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Stage1FrameIchigo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        Stage1FrameIchigo sl = new Stage1FrameIchigo(defaultPlayerName);
